...
void buscaresp() {
    ...
    while(s != NULL)
    {
        if (s->dato.espanol == esp)
          cont++;
        s = s->sig;
    }
    cout << "Se encontraron " << cont << " libros en espaniol \n";
}
...
void buscarcyfy() {
    ...
    cout << "Se encontraron " << cont << " libros de ciencia ficcion \n";
}
...
void menux()
{
  ...
  do {
    int opcion = 0;
    cout << "Opciones extra: \n\t1) Buscar libros en espaniol"
         << "\n\t2) Buscar libros de ciencia ficcion"
         << "\n\t3) Eliminar los libros de misterio"
         << "\n\t4) Regresar"
         << "\n\tOpcion elegida: ";
         cin >> opcion;
         switch (opcion) {
           case 1: cout << "Buscando..." << endl;
           buscaresp();
           break;

           case 2: cout << "Buscando..." << endl;
           buscarcyfy();
           break;

           case 3: cout << "Eliminando..." << endl;
           eliminarmis();
           cout << "Todos los libros de misterio han sido eliminados" << endl;
           break;
